...
import BlogBanner from "@/public/assets/images/xanhlen.png";
...
export default function BlogPage() {
  ...
  useEffect(() => {
    const fetchBlogs = async () => {
      setIsLoading(true);
      try {
        const response = await fetch('/api/blog?type=upgreen');
      ...
      <main className="flex-grow pt-32">
        <div className="max-w-screen-xl mx-auto px-4">
          <div className="text-center mb-12">
            <h1 className="text-5xl font-bold text-[#329A1F] mb-6">UPGREEN 
              <span className="text-[#344054]">VIETNAM</span>
            </h1>
            <p className="text-[#344054] max-w-3xl mx-auto">
            UPGREEN Vietnam is a creative social enterprise turning plastic waste into purposeful, culturally inspired products.
We combine circular economy, sustainability education, and community empowerment to build a greener future – one design, one story, and one impact-driven product at a time.
            </p>
          </div>
