...
import BlogBanner from "@/public/assets/images/slide2.png";
...
export default function BlogPage() {
  ...
  useEffect(() => {
    const fetchBlogs = async () => {
      setIsLoading(true);
      try {
        const response = await fetch('/api/blog?type=speaking');
      ...
      <main className="flex-grow pt-32">
        <div className="max-w-screen-xl mx-auto px-4">
          <div className="text-center mb-12">
            <h1 className="text-5xl font-bold text-[#329A1F] mb-6">Public 
              <span className="text-[#344054]"> Speaking</span>
            </h1>
            <p className="text-[#344054] max-w-3xl mx-auto">
            For me, speaking is more than just standing on a stage – it’s about using my voice to inspire action and amplify the stories that matter.

pWhether it’s discussing sustainability, circular economy, or youth empowerment, I see public speaking as a powerful way to turn personal experiences into collective momentum.
            </p>
          </div>
