...
export default function BlogPage() {
  ...
  useEffect(() => {
    const fetchBlogs = async () => {
      setIsLoading(true);
      try {
        const response = await fetch('/api/blog?type=education');
      ...
      <main className="flex-grow pt-32">
        <div className="max-w-screen-xl mx-auto px-4">
          <div className="text-center mb-12">
            <h1 className="text-5xl font-bold text-[#329A1F] mb-6">Youth Empowerment 
              <span className="text-blue-400"> Through Education</span>
            </h1>
            <p className="text-[#344054] max-w-3xl mx-auto">
            I believe education is the spark that ignites transformation.
Through workshops, mentoring, and scholarship programs, I empower young people to unlock their potential, develop global mindsets, and lead purpose-driven projects that create real impact in their communities and beyond.
            </p>
          </div>
          ...
          <div className="relative w-full h-[400px] rounded-2xl overflow-hidden mb-16">
            ...
            <div className="absolute bottom-0 left-0 w-full p-8">
              ...
              <p className="text-white/80">Discover my thoughts on education, sustainability, and creativity</p>
            </div>
          </div>
